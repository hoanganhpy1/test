...
class HomeContainer extends React.Component {
    ...
    render() {
        const { category, publisher, product, totalpage } = this.props
        if (category !== null && publisher !== null && product !== null && totalpage !== null) {
            return (
                <div>
                    <Home
...
const mapStateToProps = state => ({
    ...
    totalpage: state.homeReducers.product.totalpage,
    page: state.homeReducers.product.page,
    sortType: state.homeReducers.product.sortType,
    title: state.homeReducers.product.title,
    branch: state.homeReducers.product.branch
})
