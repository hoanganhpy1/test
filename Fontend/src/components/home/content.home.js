                ...
                <div className="price-range">
                  ...
                  <div className="well ">
                    ...
                    <div className="radio">
                      <label
                        onClick={() => {
                          this.props.setRangeType({ low: 0, high: 10000000 });
                          this.resetCheck();
                    ...
                    <div className="radio ">
                      <label
                        onClick={() => {
                          this.props.setRangeType({ low: 10000000, high: 20000000 });
                          this.resetCheck();
                    ...
                    <div className="radio ">
                      <label
                        onClick={() => {
                          ...
                          this.props.setRangeType({ low: 20000000, high: 30000000 });
                        }}
                      >
                        <input
                          type="radio"
                    ...
                    <div className="radio ">
                      <label
                        onClick={() => {
                          this.props.setRangeType({ low: 30000000, high: 40000000 });
                          this.resetCheck();
